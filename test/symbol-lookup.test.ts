  ...
  return buildIndex(
    {
      symbols: [
        {
          id: "src/payments/charge.ts#charge",
          name: "charge",
          kind: "function",
          container: null,
        ...
        {
          id: "src/refunds/charge.ts#charge",
          name: "charge",
          kind: "function",
          container: null,
          file: "src/refunds/charge.ts",
          startLine: 4,
          endLine: 9,
          tokens: 10,
        },
        {
          id: "src/orders/create.ts#createOrder",
          name: "createOrder",
          kind: "function",
          container: null,
      ...
      edges: [
        {
          from: "src/orders/create.ts#createOrder",
          to: "src/payments/charge.ts#charge",
          weight: 1,
          strategy: "importMap",
        },
      ],
