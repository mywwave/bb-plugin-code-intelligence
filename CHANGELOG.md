...
- Patch releases fix compatible behavior or documentation.
- Minor releases add compatible tools, options, or capabilities.
- Major releases change or remove tool, installation, or other public
  contracts.
