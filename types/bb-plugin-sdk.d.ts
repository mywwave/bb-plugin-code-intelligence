...
type PluginRpcCallArgs<Method extends PluginRpcMethodContract> =
  null extends PluginRpcCallInput<Method> ? [input?: PluginRpcCallInput<Method>] : [input: PluginRpcCallInput<Method>];
...
interface PluginThreadPanelActionContext {
   ...
   */
  openPanel(options?: { title?: string; params?: JsonValue$1 }): void;
}
...
interface BbNavigate {
   ...
   */
  experimental_openThreadPanel(options: { actionId: string; title?: string; params?: JsonValue$1 }): boolean;
}
/**
                ...
                rawEvent: z$1.ZodObject<
                  {
                    ...
                    params: z$1.ZodOptional<
                      z$1.ZodType<JsonValue, unknown, z$1.core.$ZodTypeInternals<JsonValue, unknown>>
                    >;
                  },
                  z$1.core.$strip
                >;
...
type HostDaemonCommandDescriptorForTransport<Transport extends HostDaemonCommandTransport> = Extract<
...
declare const timelineToolWorkRowSchema: z$1.ZodObject<
  {
    ...
    toolArgs: z$1.ZodNullable<
      z$1.ZodRecord<z$1.ZodString, z$1.ZodType<JsonValue, unknown, z$1.core.$ZodTypeInternals<JsonValue, unknown>>>
    >;
    output: z$1.ZodString;
    completedAt: z$1.ZodNullable<z$1.ZodNumber>;
    approvalStatus: z$1.ZodNullable<
...
declare const createThreadRequestSchema: z$1.ZodObject<
  {
    ...
    permissionMode: z$1.ZodOptional<
      z$1.ZodPipe<
        ...
        >,
        z$1.ZodTransform<"auto" | "accept-edits" | "full", "auto" | "accept-edits" | "full" | "workspace-write">
      >
    >;
...
type BbRealtimeSubscribeArgs<TEventName extends BbRealtimeEventName = BbRealtimeEventName> = Extract<
...
interface PluginAgents {
   ...
   */
  contributeInstructions(provider: (ctx: { threadId: string; projectId: string }) => string | null): void;
}
